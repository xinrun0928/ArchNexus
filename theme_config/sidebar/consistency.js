export const consistencySidebar = [
    ...
    },
    {
        ...
        items: [
            ...
            { text: '读写冲突解决', link: '/consistency/eventual/conflict-resolution' },
    ...
    },
    {
        ...
        items: [
            ...
            { text: '读写分离的最佳实践', link: '/consistency/read-write/best-practices' }
        ]
    },
    {
        text: '缓存一致性',
        ...
        items: [
            ...
            { text: 'Read Through 与 Write Through', link: '/consistency/cache/read-write-through' },
    ...
    },
    {
        ...
        items: [
            { text: '分布式事务的挑战', link: '/consistency/distributed-tx/challenges' },
            { text: 'TCC 模式', link: '/consistency/distributed-tx/tcc' },
            { text: '本地消息表', link: '/consistency/distributed-tx/local-message' },
            { text: '事务消息', link: '/consistency/distributed-tx/transaction-message' }
        ]
    }
];
