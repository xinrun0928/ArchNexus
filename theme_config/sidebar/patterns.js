export const patternsSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '责任链模式',
        link: '/patterns/behavioral/chain-of-responsibility',
      },
  ...
  },
  {
    ...
    items: [
      {
        text: '生产者-消费者模式',
        link: '/patterns/concurrent/producer-consumer',
      },
      { text: '读写锁模式', link: '/patterns/concurrent/read-write-lock' },
      { text: 'Future 模式', link: '/patterns/concurrent/future' },
      {
        text: 'Guarded Suspension 模式',
        link: '/patterns/concurrent/guarded-suspension',
      },
