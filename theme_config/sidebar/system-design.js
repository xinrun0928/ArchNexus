export const systemDesignSidebar = [
    {
        ...
        items: [
            ...
            { text: '需求分析与边界确定', link: '/system-design/methodology/requirements' },
    ...
    },
    {
        ...
        items: [
            ...
            { text: '延迟 vs 吞吐量', link: '/system-design/tradeoffs/latency-throughput' },
            { text: '一致性 vs 可用性', link: '/system-design/tradeoffs/consistency-availability' },
            { text: '存储成本 vs 查询性能', link: '/system-design/tradeoffs/cost-performance' }
        ]
    },
    {
        text: '扩展策略',
    ...
    },
    {
        ...
        items: [
            ...
            { text: '缓存穿透、击穿、雪崩', link: '/system-design/caching/penetration-breakdown-avalanche' },
    ...
    },
    {
        ...
        items: [
            { text: '负载均衡算法', link: '/system-design/load-balancing/algorithms' },
            { text: '四层 vs 七层负载均衡', link: '/system-design/load-balancing/l4-l7' },
            { text: '健康检查机制', link: '/system-design/load-balancing/health-check' },
            { text: '会话保持策略', link: '/system-design/load-balancing/session-persistence' }
        ]
    },
    {
        text: '消息队列选型',
        ...
        items: [
            { text: 'Kafka vs RabbitMQ vs RocketMQ', link: '/system-design/message-queue/comparison' },
            { text: '消息可靠性保证', link: '/system-design/message-queue/reliability' },
