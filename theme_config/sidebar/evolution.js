export const evolutionSidebar = [
  {
    ...
    items: [
      {
        text: '单体架构的特点',
        link: '/evolution/monolith-to-microservices/monolith',
      },
      {
        text: '微服务架构的特点',
        link: '/evolution/monolith-to-microservices/microservices',
      },
      {
        text: '拆分的时机与方式',
        link: '/evolution/monolith-to-microservices/timing-method',
      },
      {
        text: '拆分后的挑战',
        link: '/evolution/monolith-to-microservices/challenges',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        text: '前后端分离',
        link: '/evolution/service-decomposition/frontend-backend',
      },
      {
        text: '服务粒度控制',
        link: '/evolution/service-decomposition/granularity',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        text: '选型原则',
        link: '/evolution/architecture-selection/principles',
      },
      {
        text: '技术栈选型',
        link: '/evolution/architecture-selection/tech-stack',
      },
      {
        text: '中间件选型',
        link: '/evolution/architecture-selection/middleware',
      },
      {
        text: '成本与效益分析',
        link: '/evolution/architecture-selection/cost-benefit',
      },
    ],
  },
  {
