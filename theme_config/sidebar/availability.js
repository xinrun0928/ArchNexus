export const availabilitySidebar = [
    ...
    },
    {
        ...
        items: [
            ...
            { text: '熔断状态机', link: '/availability/circuit-breaker/state-machine' },
            { text: '熔断阈值设置', link: '/availability/circuit-breaker/threshold' },
            { text: '半开状态的处理', link: '/availability/circuit-breaker/half-open' }
        ]
    },
    {
        text: '限流策略',
        ...
        items: [
            ...
            { text: '固定窗口与滑动窗口', link: '/availability/rate-limiting/window' }
        ]
    },
    {
        text: '降级策略',
        ...
        items: [
            ...
            { text: '自动降级 vs 手动降级', link: '/availability/degradation/auto-manual' },
    ...
    },
    {
        ...
        items: [
            ...
            { text: '指数退避', link: '/availability/timeout-retry/exponential-backoff' },
            { text: '重试的副作用', link: '/availability/timeout-retry/side-effects' }
        ]
    },
    {
        text: '健康检查',
        ...
        items: [
            ...
            { text: '健康检查最佳实践', link: '/availability/health-check/best-practices' }
        ]
    }
];
