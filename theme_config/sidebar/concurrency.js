export const concurrencySidebar = [
  ...
  },
  {
    ...
    items: [
      {
        text: '乐观锁的实现',
        link: '/concurrency/optimistic-pessimistic/optimistic',
      },
      {
        text: '悲观锁的实现',
        link: '/concurrency/optimistic-pessimistic/pessimistic',
      },
      {
        text: 'CAS 原理与 ABA 问题',
        link: '/concurrency/optimistic-pessimistic/cas-aba',
      },
      {
        text: '乐观锁与悲观锁的选择',
        link: '/concurrency/optimistic-pessimistic/selection',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        text: '脏读、不可重复读、幻读',
        link: '/concurrency/isolation/anomalies',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: 'CopyOnWrite 机制',
        link: '/concurrency/data-structures/copy-on-write',
      },
    ],
  },
];
