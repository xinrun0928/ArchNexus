export const analysisSidebar = [
  {
    ...
    items: [
      ...
      { text: 'LinkedIn 架构', link: '/analysis/famous-architectures/linkedin' },
      { text: 'Stripe 支付架构', link: '/analysis/famous-architectures/stripe' },
      { text: 'Twitter 流架构', link: '/analysis/famous-architectures/twitter' },
      { text: '阿里中台架构', link: '/analysis/famous-architectures/alibaba' },
      { text: '字节推荐架构', link: '/analysis/famous-architectures/bytedance' },
      { text: '腾讯即时通讯架构', link: '/analysis/famous-architectures/tencent' },
      { text: '美团本地生活架构', link: '/analysis/famous-architectures/meituan' },
      { text: '滴滴出行架构', link: '/analysis/famous-architectures/didi' },
      { text: '快手短视频架构', link: '/analysis/famous-architectures/kuaishou' },
    ],
  },
  {
    text: '故障案例',
