export const analysisSidebar = [
    ...
    },
    {
        ...
        items: [
            { text: '从单体到微服务', link: '/analysis/migration-cases/monolith-to-microservices' },
            { text: '云原生迁移', link: '/analysis/migration-cases/cloud-native' },
            { text: '技术栈迁移', link: '/analysis/migration-cases/tech-stack' },
            { text: '数据迁移实战', link: '/analysis/migration-cases/data-migration' }
        ]
    },
    {
        text: '极限场景处理',
        ...
        items: [
            ...
            { text: '高并发抢购', link: '/analysis/extreme-scenarios/high-concurrency' },
