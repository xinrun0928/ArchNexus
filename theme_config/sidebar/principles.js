export const principlesSidebar = [
    {
        ...
        items: [
            ...
            { text: 'CAP 与 BASE 的权衡', link: '/principles/cap-base/cap-base-tradeoff' }
        ]
    },
    {
        text: '一致性模型',
    ...
    },
    {
        ...
        items: [
            ...
            { text: '如何实现幂等性', link: '/principles/idempotency/implementation' },
            { text: '常见场景的幂等性设计', link: '/principles/idempotency/scenarios' }
        ]
    }
];
