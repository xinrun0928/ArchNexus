...
5. [配置中心模式](/patterns/microservices/config-center)——集中化配置管理
6. [分布式配置](/patterns/microservices/distributed-config)——Spring Cloud Config 实战
...
11. [外部化配置模式](/patterns/microservices/external-config)——配置与代码分离
...
14. [遥测监控模式](/patterns/microservices/telemetry)——指标采集与告警
